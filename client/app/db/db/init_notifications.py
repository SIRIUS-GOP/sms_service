...
cur.execute("INSERT INTO notifications_db (pv1, rule1, limits1, subrule1, owner, phone) VALUES (?, ?, ?, ?, ?, ?)",
            ('SI-13C4:DI-DCCT:Current-Mon', 'pv < L', 'L=0.05', '0', 'rone.castro', '(XX)12345-6789')
            )
